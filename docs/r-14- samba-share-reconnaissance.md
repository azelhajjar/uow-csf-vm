...
```bash
nmap -sV -p 139,445 --script default 192.168.144.100
```
...
```bash
nmap -p 139,445 --script smb-enum-shares,smb-os-discovery,smb-protocols,smb-vuln-cve-2017-7494 192.168.144.100
```
