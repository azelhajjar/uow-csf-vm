...
```bash
nc -nv 192.168.144.131 22
```

```
Connection to 192.168.144.131 22 port [tcp/*] succeeded!
SSH-2.0-OpenSSH_9.2p1 Debian-2+deb12u3
```

```bash
nc -nv 192.168.144.131 2222
```

```
Connection to 192.168.144.131 2222 port [tcp/*] succeeded!
...
The authenticity of host '[192.168.144.131]:2222 ([192.168.144.131]:2222)' can't be established.
...
```bash
nmap -p 22,2222 --script ssh2-enum-algos 192.168.144.131
```
...
```bash
nmap -p 22,2222 --script ssh-hostkey --script-args ssh_hostkey=full 192.168.144.131
```
...
```bash
nmap -p 22,2222 --script ssh-auth-methods 192.168.144.131
```
...
```
[*] 192.168.144.131 - SSH server version: SSH-2.0-OpenSSH_9.2p1 Debian-2+deb12u3
[*] 192.168.144.131 - Server Information and Encryption
=================================
  Type                     Value                                 Note
  ----                     -----                                 ----
...
```
[*] 192.168.144.131 - SSH server version: SSH-2.0-Erlang/5.1.4.7
[*] 192.168.144.131 - Server Information and Encryption
=================================
  Type                     Value                                 Note
  ----                     -----                                 ----
