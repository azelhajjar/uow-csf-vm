...
```bash
nmap -sV -p 6379 192.168.144.100
```
...
```bash
nmap -p 6379 --script redis-info 192.168.144.100
```
...
```bash
redis-cli -h 192.168.144.100 ping
```
...
```bash
redis-cli -h 192.168.144.100 info server
```
...
```bash
redis-cli -h 192.168.144.100 keys '*'
```
