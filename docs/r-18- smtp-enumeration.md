...
```bash
nmap -p 25 --script smtp-commands 192.168.144.100
```
...
```bash
nmap -p 25 --script smtp-open-relay 192.168.144.100
```
...
```bash
nmap -p 25 --script smtp-enum-users 192.168.144.100
```
...
```bash
nmap -p 25 --script smtp-enum-users --script-args smtp-enum-users.methods=RCPT,smtp-enum-users.userdb=/tmp/real_users.txt 192.168.144.100
```
...
```bash
nmap -p 25 --script smtp-enum-users --script-args userdb=/tmp/real_users.txt 192.168.144.100
```
```
| smtp-enum-users:
|   analyst
...
```bash
nmap -p 25 --script smtp-enum-users --script-args userdb=/tmp/real_users.txt -d 192.168.144.100 2>&1 | grep -i "RCPT"
```
```
|   RCPT, analyst
|   RCPT, webops
...
```bash
nmap -p 25 --script smtp-vuln-cve2010-4344,smtp-vuln-cve2011-1720,smtp-vuln-cve2011-1764 192.168.144.100
```
