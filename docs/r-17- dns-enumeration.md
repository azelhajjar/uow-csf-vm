...
```bash
dig @192.168.144.100 uow-csf.internal NS
```
...
```bash
dig @192.168.144.100 print.uow-csf.internal A
```

```
;; ANSWER SECTION:
print.uow-csf.internal. 604800  IN      A       192.168.144.100
```
...
```bash
dig @192.168.144.100 uow-csf.internal AXFR
```
...
files.uow-csf.internal. 604800  IN      A       192.168.144.100
mail.uow-csf.internal.  604800  IN      A       192.168.144.100
ns1.uow-csf.internal.   604800  IN      A       192.168.144.100
print.uow-csf.internal. 604800  IN      A       192.168.144.100
vpn-internal.uow-csf.internal. 604800 IN A      192.168.144.150
www.uow-csf.internal.   604800  IN      A       192.168.144.100
```
...
```bash
nmap -p 53 --script dns-zone-transfer --script-args dns-zone-transfer.domain=uow-csf.internal 192.168.144.100
```
